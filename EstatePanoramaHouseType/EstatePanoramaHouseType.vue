<template>
	<div>
		<el-row style="border:1px solid #ccc;padding:20px 10px 0px">
			...
			<el-col :span="4">
				<el-button style="float:right;margin-left:5px;" type="primary" @click="addNew" v-if="type==='edit'">添加户内全景</el-button>
		...
		<BigDialog dialogTitle="添加户内全景" :dialogFormVisible="dialogFormVisible" @dialogCancel="dialogCancel(1)" @dialogConfirm="dialogConfirm(1)">
			<div slot="dia_body">
		...
		<BigDialog dialogTitle="户内全景详情" :isShowCancel="false" :dialogFormVisible="viewDialogFormVisible" @dialogCancel="dialogCancel(2)" @dialogConfirm="dialogConfirm(2)">
			<div slot="dia_body">
